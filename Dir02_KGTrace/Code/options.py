...
def read_options() -> object:
    parser = argparse.ArgumentParser()
    # parser.add_argument("--data_input_dir", default="", type=str)
    parser.add_argument("--txt_dir", default="", type=str)
    parser.add_argument("--bern_txt_dir", default="", type=str)
    ...
    parser.add_argument("--path_length", default=6, type=int)
    ...
    parser.add_argument("--negative_reward", default=-1, type=float)
    ...
    parsed['input_files'] = [parsed['txt_dir'] + '/' + parsed['input_file']]
    parsed['vocab_dir'] = parsed['bern_txt_dir'] + '/vocab'
